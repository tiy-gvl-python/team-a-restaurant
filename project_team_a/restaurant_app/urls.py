...
from .views import home, menu, ItemCreateView, ItemDeleteView, ItemListView, ItemDetailView, ItemUpdateView, CategoryListView, \
    ...
    permission_denied, removefromorder, checkout, order, ordercomplete, ordersubmit, CommentCreateView, CommentDeleteView, CommentListView, CommentUpdateView
...
urlpatterns = [
    ...
    url(r'^comment_update/(?P<pk>\d+)$', CommentUpdateView.as_view(), name="comment_update"),
